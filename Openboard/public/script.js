...
ide.style.height = ((window.innerHeight * 90) / 100) + "px";
...
// let currentMode = true; // true -> light
// mode.addEventListener("click" , function(){
//     console.log("mode : ",currentMode);
//     if(currentMode ){
//         let img = document.querySelector("#mode img")
//         img.setAttribute('src' , "./icons/night-mode.png");
//         canvasBoard.style.filter = "invert(100%)";
//         // body.style.backgroundColor = "black";
//     }else{
//         let img = document.querySelector("#mode img")
//         img.setAttribute('src' , "./icons/light-mode.png");
//         //
